export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'revilume',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Revilume',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'revilume.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://revilume.com',
